...
public class SubscribeMemeAdapter extends MemeAdapter {
    private SecondMemeAdapter secondMemeAdapter;

    @SuppressLint("UseSparseArrays")
    public SubscribeMemeAdapter(Context context, ArrayList<Meme> memes) {
        super(context, memes);
    }

    public SubscribeMemeAdapter(Context context, String url) {
        super(context, url);
    }
